...
public class AnnonceContoller {
    ...
    @GetMapping("/Annonces_publie_include_annonceurid")
    List<FiltreAnnonceResponse> Get_annonces_publie_include_annonceurid(){
        return  annonceService.getAllAnnoncesPublieIncludeAnnonceurid();
    }
    ...
    @PostMapping("/filtre_annonce_publiee_mobile")
    public List<FiltreAnnonceResponse> filtrerAnnoncesPublieeMobile(@RequestBody FiltreAnnonceRequest filtreRequest) {
        return annonceService.filtrerAnnoncesPublieeMobile(
                filtreRequest.getTypeBien(),
                filtreRequest.getOperationType(),
                filtreRequest.getMinSurface(),
                filtreRequest.getMaxSurface(),
